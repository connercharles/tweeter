...
public class UnfollowServiceImplTest {
    ...
    public void testUnfollow_validRequest_correctResponse() throws IOException, TweeterRemoteException {
        ...
        unfollowServiceImplSpy = Mockito.mock(UnfollowServiceImpl.class);
        Mockito.when(unfollowServiceImplSpy.unfollow(request)).thenReturn(expectedResponse);
